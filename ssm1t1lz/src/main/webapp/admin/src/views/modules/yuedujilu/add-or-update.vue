<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="阅读进度" prop="yuedujindu">
          <el-input v-model="ruleForm.yuedujindu" 
              placeholder="阅读进度" clearable  :readonly="ro.yuedujindu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="阅读进度" prop="yuedujindu">
              <el-input v-model="ruleForm.yuedujindu" 
                placeholder="阅读进度" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
