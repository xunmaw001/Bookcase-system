<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="内容关键词" prop="neirongguanjianci">
          <el-input v-model="ruleForm.neirongguanjianci" 
              placeholder="内容关键词" clearable  :readonly="ro.neirongguanjianci"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="内容关键词" prop="neirongguanjianci">
              <el-input v-model="ruleForm.neirongguanjianci" 
                placeholder="内容关键词" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="图书简介" prop="tushujianjie">
          <el-input v-model="ruleForm.tushujianjie" 
              placeholder="图书简介" clearable  :readonly="ro.tushujianjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="图书简介" prop="tushujianjie">
              <el-input v-model="ruleForm.tushujianjie" 
                placeholder="图书简介" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.tushushangchuan" label="图书上传" prop="tushushangchuan">
          <file-upload
          tip="点击上传图书上传"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.tushushangchuan?ruleForm.tushushangchuan:''"
          @change="tushushangchuanUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.tushushangchuan" label="图书上传" prop="tushushangchuan">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tushushangchuan.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="图书下载" prop="tushuxiazai">
          <file-upload
          tip="点击上传图书下载"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tushuxiazai" label="图书下载" prop="tushuxiazai">
            <el-button type="text" size="small" @click="download(ruleForm.tushuxiazai)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      </el-row>
...
export default {
  data() {
	...
	neirongguanjianci : false,
	tushubianhao : false,
	tushuleixing : false,
	tushujianjie : false,
	tupian : false,
	tushushangchuan : false,
	tushuxiazai : false,
      },
      ruleForm: {
        tushumingcheng: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tushumingcheng = true;
          ...
          if(o=='neirongguanjianci'){
            this.ruleForm.neirongguanjianci = obj[o];
	    this.ro.neirongguanjianci = true;
            continue;
          }
          if(o=='tushubianhao'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='tushushangchuan'){
            this.ruleForm.tushushangchuan = obj[o];
	    this.ro.tushushangchuan = true;
            continue;
          }
          if(o=='tushuxiazai'){
    ...
    tushushangchuanUploadChange(fileUrls) {
	this.ruleForm.tushushangchuan = fileUrls;
			this.addEditUploadStyleChange()
    },
